<svg class="main1" width="100%" height="100%">
  <defs>
    <linearGradient id="grad1" x1="50%" y1="0%" x2="50%" y2="100%">
      <stop
        offset="10%"
        style="stop-color: rgb(219, 219, 219); stop-opacity: 0.9"
      />
      <stop
        offset="99%"
        style="stop-color: rgba(75, 75, 75, 0.349); stop-opacity: 0.1"
      />
    </linearGradient>
  ...
  <g class="m1_stage" opacity="0">
    <g class="m1_cGroup">
      ...
      <g class="m1Orb orb4b">
        <image
          xlink:href="https://assets.codepen.io/721952/logoVue.png"
          width="40"
          height="40"
        />
      </g>
    ...
    <g class="m1_cGroup">
      ...
      <g class="m1Orb orb3c">
        <image
          xlink:href="https://assets.codepen.io/721952/logoAngular.png"
          width="40"
          height="40"
        />
      </g>
      ...
      <g class="m1Orb orb3b">
        <image
          xlink:href="https://assets.codepen.io/721952/logoReact.png"
          width="40"
          height="40"
        />
      </g>
    ...
    <g class="m1_cGroup">
      ...
      <g class="m1Orb orb1">
        ...
        <circle cx="12.5" cy="7" r="20" fill="none" stroke="none" />
        <path
          fill="#fff"
          opacity="0.7"
...
window.onresize = window.onload = function () {
  gsap.set(".m1_stage", { x: "50%", y: "50%", opacity: 1 });
};
